...
var ToDoCollection = Backbone.Collection.extend({
  model: ToDoItem,
  url: 'http://tiny-pizza-server.herokuapp.com/collections/encumbered'
});

// Results View
var ToDoView = Backbone.View.extend({

  renderTemplate: _.template($('.todoList-item').text()),
  editTemplate: _.template($('.edit-line-item').text()),

  events: {
    'click .remove-image' : 'removeLine',
    'click .todoList'   : 'editLine',
  ...
  markDone: function () {
    ...
    this.$el.find('.todoList').toggleClass('strikethrough')
  }
